...
import OtpVerificationAuthForm from "./otp-verification-auth-form";
import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import { userAuthSchema, UserAuthSchemaType } from "@/schema/auth-schema";
import { useLoginSendOtp, useSignupSendOtp } from "@/hooks/auth-hook";
...
export function PasswordLessAuthForm({
  ...
  const authForm = useForm({
    resolver: zodResolver(userAuthSchema(isSignup)),
    defaultValues: {
      fullName: "",
      email: "",
    },
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      {!isOtpStep ? (
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-6">
              ...
              <Field className="grid grid-cols-1 gap-4 mt-6">
                {/* <Button
                  variant="outline"
                  type="button"
        ...
        <OtpVerificationAuthForm email={email} name={name} onResendOTP={onSubmit} />
      )}
